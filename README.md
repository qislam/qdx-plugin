...
running command...
$ sf (--version)
qdx-plugin/1.3.0 darwin-arm64 node-v24.14.0
$ sf --help [COMMAND]
USAGE
  $ sf COMMAND
...
...
_See code: [src/commands/qdx/migrate.ts](https://github.com/qislam/qdx-plugin/blob/v1.3.0/src/commands/qdx/migrate.ts)_
...
_See code: [src/commands/qdx/package.ts](https://github.com/qislam/qdx-plugin/blob/v1.3.0/src/commands/qdx/package.ts)_
...
_See code: [src/commands/qdx/release.ts](https://github.com/qislam/qdx-plugin/blob/v1.3.0/src/commands/qdx/release.ts)_
...
_See code: [src/commands/qdx/snippet.ts](https://github.com/qislam/qdx-plugin/blob/v1.3.0/src/commands/qdx/snippet.ts)_
<!-- commandsstop -->
